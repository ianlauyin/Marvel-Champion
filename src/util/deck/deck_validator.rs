...
use crate::{cards::IdentitySet, component::card::CardBasic};

use super::DeckUtil;

pub struct DeckValidator {
    identity: IdentitySet,
    validators: Vec<fn(&Vec<CardBasic<'static>>) -> Result<(), String>>,
}
...
impl DeckValidator {
    ...
    pub fn validate(&mut self, deck_cards: &Vec<CardBasic<'static>>) -> Result<(), String> {
        self.validators
            .iter_mut()
...
pub fn aspects_rules_validator(deck_cards: &Vec<CardBasic<'static>>) -> Result<(), String> {
...
fn deck_cards_amount_validator(deck_cards: &Vec<CardBasic<'static>>) -> Result<(), String> {
...
fn cards_amount_limit_validator(deck_cards: &Vec<CardBasic<'static>>) -> Result<(), String> {
